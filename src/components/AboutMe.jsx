    ...
    <section id="about" className="about-section">
      <div className="about-container">
        ...
        <div className="about-content">
          ...
          <PillNav
            items={navItems}
            activeHref={activeSkillCategory}
            onItemClick={setActiveSkillCategory}
            baseColor="#0A1929"
            pillColor="rgba(30, 40, 60, 0.8)"
          ...
          <div className="about-links">
            <a 
              href="https://www.linkedin.com/in/widad-alli-1b381331a/" 
              target="_blank" 
